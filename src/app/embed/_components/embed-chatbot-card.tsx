 ...
 * @returns Full chatbot embed URL
 */
...
/**
 * EmbedChatbotCard Component Props
 */
interface EmbedChatbotCardProps {
...
/**
 * EmbedChatbotCard Component
 * Renders a chatbot card with iframe embedding
 */
export function EmbedChatbotCard({
  agentId,
  agentName = "Embed Agent",
}: EmbedChatbotCardProps) {
